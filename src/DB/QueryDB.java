...
public class QueryDB {
    ...
    public static String sql =
            //"SELECT COUNT(1) CONN_COUNT from sqlite_master where name = ";
            "SELECT COUNT(1) CONN_COUNT from CLOUD_SQL_CONNECTIONS where CONN_NAME = ";
    ...
    public static void main(String[] args) throws SQLException {
        try {
            ...
            while (rs.next()) {
                System.out.println("");
                for (int x = 1; x <= columns; x++) System.out.format("%30s", rs.getString(1) + " | ");
            }
